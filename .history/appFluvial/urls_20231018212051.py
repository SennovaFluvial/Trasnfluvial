...
urlpatterns = [
    ...
    path('card/1/carga', views.logistica, name='LOGÍSTICA-CARGA'),
    path('card/1/pago', views.logistica, name='LOGÍSTICA-PAGO'),
    path('card/1/revision', views.logistica, name='LOGÍSTICA-REVISIÓN'),
