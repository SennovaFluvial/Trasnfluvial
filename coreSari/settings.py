...
SECRET_KEY = 'django-insecure-9**&lj-0btuuxgb02zr%fhl)&8=5_7yih@&fow_q5p)-x5q&#^'
...
WSGI_APPLICATION = 'coreSari.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'bojzvkjb',               # Nombre de la base de datos
